     ...
     <div className="pt-5 pb-10 px-8 md:px-20 md:py-[4%] bg-black">
        ...
        {devservice.map((x) => {
          return (
            ...
            <div key={x.id} className="bg-gradient-to-bl from-[#D3FF25] to-[#333131B2] p-[2px]  rounded-xl w-[100%] md:w-[45%]">
              ...
              <p className="text-[#BCB2B2] text-[15px] md:text-[18px] w-[100%] md:w-[70%] mb-[5%]">
                {x.writeup}
              </p>
      ...
      <div className='flex flex-col md:flex-row justify-center gap-3 md:gap-0 md:justify-between mt-[5%]'>
        <h1 className='font-bold text-white text-[20px]'>Have Any Other <span className='text-[#D3FF25] '> Tech Services </span> You Want Us To Work On?</h1>
         <button onClick={()=>navigate('/contact')} className='bg-gradient-to-b  from-[#95B809] to-[#425204] px-4 py-2.5 rounded-3xl text-black text-[18px] md:text-lg hover:bg-[#D3FF25]'> contact us</button>
      </div>
    </div>
  )
}
