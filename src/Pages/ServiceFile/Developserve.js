  ...
  return (
     <div className="pt-5 pb-10 px-8 md:px-20 md:py-[4%] bg-black">
      <h1 className="mb-[3%] text-white text-[30px] md:text-[48px] font-extrabold">
        <span className="text-[#B9DE2C] ">Development</span> Services
      </h1>
       ...
       <div className="flex flex-wrap gap-5 md:gap-10">
        {devservice.map((x) => {
          return (
            ...
            <div key={x.id} className="bg-gradient-to-bl from-[#D3FF25B2] to-[#333131B2] p-[2px]  rounded-xl w-[45%]">
              ...
              <div className='flex items-center md:items-start gap-3 flex-wrap justify-center md:justify-start lg:gap-10'>
               <button className='bg-[#B9DE2C] px-4 py-2.5 rounded-3xl text-black text-[14px] md:text-lg hover:bg-white hover:text-black'>
                    {x.initialbutton}
                </button>
                <button className='bg-[#B9DE2C] px-4 py-2.5 rounded-3xl text-black text-[14px] md:text-lg hover:bg-white hover:text-black'>
                    {x.seccondbutton}
      ...
      <div className='flex flex-col md:flex-row justify-center gap-3 md:gap-0 md:justify-between mt-[5%]'>
        <h1 className='font-bold text-white text-[20px]'>Have Any Other <span className='text-[#B9DE2C] '> Tech Services </span> You Want Us To Work On?</h1>
