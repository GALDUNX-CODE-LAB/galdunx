...
const Calculation = () => {
  return (
    <div className='py-5 px-8 md:px-20 md:py-[4%] bg-gradient-to-bl from-[#173105] relative to-[#000000] flex flex-wrap justify-between'>
       ...
       <div className='absolute uniqueone rotateimage top-[5%] text-[40px]  font-extrabold right-[5%]'>+</div>
              <div className='absolute  uniqueone  bottom-[3%] left-[5%] text-[40px]  font-extrabold right-[5%]'>+</div>
    </div>
  )
}
