...
const Home = () => {
  return (
    <>
    <div className='flex-col md:flex-row flex justify-center md:justify-between items-center w-full py-5 px-8 md:px-20  md:py-10 gap-5 bg-gradient-to-bl from-[#4B7B2A] to-[#0C0F0A]' >
      <div className='w-[100%] md:w-[45%] flex items-center md:items-start justify-center flex-col gap-5 lg:gap-7 ' >
        <div className='text-[30px] lg:text-[40px]  font-extrabold'>
            <h1 className='text-white'>The <span className='text-[#B9DE2C] font-bold'>Essential </span> Web Application Developers</h1>
        </div>
        ...
        <div className='flex  gap-10 '>
            <button className='bg-white shadow-lg rounded-3xl px-4 py-2.5 text-black text-[18px] md:text-lg hover:bg-[#B9DE2C]'>see our work</button>
             <button className='bg-[#B9DE2C] px-4 py-2.5 rounded-3xl text-black text-[18px] md:text-lg'> contact us</button>
        </div>
      </div>
